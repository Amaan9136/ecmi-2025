...
// IF I ADD SCROLLER THEN I WANT TO REPLACE THIS PART:
{/* <div className="overflow-x-auto scrollbar-thin scrollbar-thumb-gray-600"></div> */}
// WITH
{/* <div className="overflow-visible">
<table className="w-full text-white"></table> */}
// OF REGISTRATION DETAILS TABLE


// without blank space under the tables
// "use client";
// import { motion, useScroll, useTransform } from "framer-motion";
// import { useEffect, useState } from "react";
// import SectionTitle from "../helpers/SectionTitle";
...
//       <motion.div
//         style={{ opacity: tableOpacity }}
//         className="relative flex flex-wrap justify-center items-start gap-6 pb-12 px-2 sm:px-6 mt-6"
//       >
//         {/* === Important Dates Table === */}
//         <div className="rounded-xl border-l-4 border-purple-400 bg-gray-900 shadow-lg p-4 w-fit">
//           <h2 className="py-4 sm:py-6 text-white text-center text-base sm:text-lg font-bold">
//             📅 Important Dates
//           </h2>
//           <div className="overflow-x-auto scrollbar-thin scrollbar-thumb-gray-600">
//             <table className="text-white w-max">
//               <thead>
//                 <tr className="bg-gray-700 text-xs sm:text-base text-gray-300">
//                   <th className="border border-gray-600 p-2 sm:p-3">Event</th>
//                   <th className="border border-gray-600 p-2 sm:p-3">Date</th>
...
//         {/* === Registration Details Table === */}
//         <div className="rounded-xl border-l-4 border-purple-400 bg-gray-900 shadow-lg p-4 w-full max-w-4xl overflow-x-auto scrollbar-thin scrollbar-thumb-gray-600">
//           <h2 className="py-4 sm:py-6 text-white text-center text-base sm:text-lg font-bold">
//             📝 Registration Details
//           </h2>
//           <div className="overflow-visible">
